...
import { Beaker, FileText, Home, LogOut, ChevronLeft, ChevronRight, Settings, Book, Printer, Users, Facebook, Twitter, Instagram, Linkedin, Package, ShoppingCart, BarChart3, Calendar } from 'lucide-react';
...
export function Sidebar({ isCollapsed, onCollapse, enabledMenuItems, menuOrder }: SidebarProps) {
  ...
  const allNavItems = [
    ...
    { name: 'Dyeing Planning', icon: Calendar, path: '/dyeing-planning', id: 'dyeing-planning' },
